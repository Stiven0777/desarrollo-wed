...
console.log(devolverString("cludhouse"));
...
true;
console.log(sonIguales("brayan", "dairon"));
...
console.log(tienenMismaLongitud("brayan", "guevara"));
...
console.log(menosQueNoventa("brayan"));
...
function elevarAlCuadrado(num) {
  ...
  //   // Tu código:
  let cuadrado = Math.length(num, 2);
}
...
console.log(redondearHaciaArriba(9.6));

function numeroRandom() {
  //   //Generar un número al azar entre 0 y 1 y devolverlo
  //   //Pista: investigá qué hace el método Math.random()
  let numalazar = Math.random(76) * 1;
}
